...
namespace _5._3.DinamicheskiyMassivPro
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (isExitProgram == false)
            {
                ...
                switch (userInput)
                {
                    ...
                    case CommandSum:
                        ShowAmount(userNumbers);
                        break;

                    default:
                        CheckAndAddNumber(userNumbers, userInput);
                        break;
                }
        ...
        static void OutputList(List<int> numbers)
        {
        ...
        static void ShowAmount(List<int> numbers)
        {
            int sum = 0;
        ...
        static void CheckAndAddNumber(List<int> numbers, string userInput)
        {
            bool isNumber = false;
            int userNumber = 0;
