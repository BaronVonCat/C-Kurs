...
namespace _6._13.Autoservice
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (carStation.HasBankrupt == false)
            {
                ...
                TryAcceptClient(client, carStation);
            }
        ...
        static void TryAcceptClient(Client client, CarStation carStation)
        {
            ...
            while (isChoiceMade == false)
            {
                ...
                if (isChoiceMade = TryEnterNumberFromRange(CommandAcceptOrder, CommandRejectOrder, out userNumber))
                {
                    switch (userNumber)
                    {
        ...
        static bool TryEnterNumberFromRange(int numberMin, int numberMax, out int userNumber)
        {
    ...
    class CarStation
    {
        ...
        public void AcceptClient(Client client)
        {
            ...
            int paymentInvoise = CarryRepair(car) + priceRepairWork;
        ...
        private int CarryRepair(Car car)
        {
            ...
            while (isRepairCompleted == false)
            {
                ...
                switch (Console.ReadLine())
                {
                    ...
                    case CommandCarryRepairs:
                        detailPryce = TryReplaceDetail(car);
                        break;
        ...
        private int TryReplaceDetail(Car car)
        {
            int detailPrice = 0;
            Detail detail = null;
