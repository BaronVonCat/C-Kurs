...
namespace _6._10.War
{
    ...
    class Fighter
    {
        ...
        public Fighter(string nameFaction)
        {
            ...
            _name = Database.GetRandomName();
            _health = _statsBase.Health;
            _damage = _statsBase.Damage;
            IsMove = true;
        }
        ...
        {
            Console.WriteLine($"{_nameFaction} {_name} обычная атака");
        ...
        {
            Console.WriteLine($"    {_nameFaction} {_name} получил урон - {damage}");
        ...
        private void ShowStats()
        {
            ...
            Console.WriteLine($"Здоровье: {_health}/{_statsBase.Health}");
